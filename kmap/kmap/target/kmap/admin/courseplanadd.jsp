            ...
            <form id="queryform" method="get" action="">
              ...
              <div id="secondstep" class="vis">
                ...
                <div class="queryform" style="margin-left: 80px">
                  <!--start of table-->
                  <table data-toggle="table" id="coursetable" data-url="/kmap/API/CoursePlan/GetCoursesByAcademy.do?academyname=管理与经济学部" data-toolbar="#get"data-query-params="queryParams" data-cache="false" data-height="450" data-click-to-select="true">
                    <thead>
                      <tr>
...
$(function(){
    ...
    //初始化下拉表
    //获取数据
    $.get("/kmap/API/CoursePlan/GetDropDownModel.do",null,function(data,status){
