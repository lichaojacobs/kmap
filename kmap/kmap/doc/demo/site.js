(function($) {
    ...
    var that = {
      ...
      redraw: function() {
        ...
        sys.eachEdge(function(edge, p1, p2) {
          ...
          gfx.line(p1, p2, {stroke: "#20739C", width: 2, alpha: edge.target.data.alpha});
        });
        ...
        sys.eachNode(function(node, pt) {
          ...
          if (node.data.shape == 'dot') {
            ...
            ctx.arc(pt.x, pt.y, w * 0.60 , 0, 1.4 * Math.PI);
            ...
            gfx.oval(pt.x-w/2, pt.y-w/2, w, w, {fill:"green", alpha:node.data.alpha, width:0, stroke: "green"});
  ...
  var Nav = function(elt) {
    ...
    var that = {
      ...
      update:function() {
        var dt = 'fast';
        if (_path === null) {
          // this is the original page load. don't animate anything just jump to the proper state
  ...
  $(document).ready(function() {
    var theUI = {
      nodes: {
        "course":{color:"#767676", shape: "dot", alpha: 1},
        "detail-a":{color:"orange", shape: "dot", alpha:.8},
        "detail-b":{color:"orange", shape: "dot", alpha:.8},
        "detail-c":{color:"green", shape: "dot", alpha:.8},
        "detail-d":{color:"green", alpha:.8},
        "detail-e":{color:"green", alpha:.8},
        "detail-f":{color:"green", alpha:.8}
      },
      edges: {
        "course": {
          "detail-a": {length:.2},
    ...
    sys.parameters({stiffness:500, repulsion:200, gravity:false, dt:0.015});
