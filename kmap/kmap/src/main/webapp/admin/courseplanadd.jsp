...
<div class="container-fluid" id="container">
    <div class="row">
        <div class="title"><span><img src="/kmap/admin/images/logo1.png"/></span> <span>天津大学知识地图信息管理系统</span>
        </div>
    </div>
                    ...
                    <div class="newsearch">
                        ...
                        <div id="firststep">
                            <div class="querytip stepfirst"
                                 style="background-color:rgb(51, 153, 204)">①查询信息
                            </div>
                        ...
                        <div id="secondstep" class="vis">
                            <div class="querytip stepfirst"
                                 style="background-color:rgb(51, 153, 204)">②添加课程
                            </div>
                                ...
                                <div style="margin-left:86%; display:inline-block">
                                    <div class="dropdown">
                                        <button type="button"
                                                ...
                                                aria-expanded="false" aria-haspopup="true">快捷添加课程计划
                            ...
                            <div class="queryform" style="margin-left: 80px">
                                <!--start of table-->
                                <table data-toggle="table" data-toolbar="#get" id="coursetable"
                                       data-url="/kmap/API/CoursePlan/GetCoursesByAcademy.do"
                                       data-query-params="queryParams" data-height="450"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="choose" data-checkbox="true"
                                            data-title="是否选择"><span>是否选择</span></th>
                                    </tr>
                                    </thead>
                                </table>
                                <!--end of table-->
                        ...
                        <div id="thirdstep" class="vis">
                            <div class="querytip stepfirst"
                                 style="background-color:rgb(51, 153, 204)">③课程关系
                            </div>
                            <div class="quickaddplan">
                                <div class="point">
                                    <span class="glyphicon glyphicon-map-marker"
                            ...
                            <div class="queryform" style="margin-left: 80px; height:460px">
                                <!--start of table-->
                                <table data-toggle="table" id="relationtable" data-cache="false"
                                       data-height="auto" data-click-to-select="true">
                                    <thead>
    ...
    (function () {
        ...
        var GenerateOverview = function (title) {
            ...
            _html +=
                    ...
                    + '</span>';
            _html +=
                    '<a id="mb_ico">x</a><div><canvas id="sitemap" width="850" height="500"></canvas></div><div id="mb_btnbox">';
