...
public class APIPointDaoImpl implements APIPointDao {
    ...
    public List<Detail> getPointSelections(String course,String academy) {
        try {
            ...
            int academyId=jdbcTemplate.queryForObject(sqlForacademyId, new Object[]{academy}, new RowMapper<Integer>() {
                @Override
            ...
            int courseId= jdbcTemplate.queryForObject(sqlForCourseId, new Object[]{course,academyId}, new RowMapper<Integer>() {
                @Override
                public Integer mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            List<Detail> details=jdbcTemplate.query(sqlForDetail, new Object[]{courseId}, new RowMapper<Detail>() {
                @Override
    ...
    public CommonResult addPoint(String course, String pointname, String pointdescription, String pointforward, String pointbehind,String academy){
        ...
        try {
            ...
            List<Detail> details= jdbcTemplate.query(sqlForRepeated, new Object[]{pointname, courseId}, new RowMapper<Detail>() {
                @Override
                public Detail mapRow(ResultSet resultSet, int i) throws SQLException {
                    if(resultSet.next())
                    {
            ...
            }else
            {
                ...
                int detailId= jdbcTemplate.queryForObject(sqlForDetailId, new Object[]{pointname,courseId}, new RowMapper<Integer>() {
                    @Override
                    public Integer mapRow(ResultSet resultSet, int i) throws SQLException {
                        return resultSet.getInt("id");
                    }
